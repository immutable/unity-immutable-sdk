...
namespace Immutable.Audience.Samples.SampleApp
{
    ...
    public sealed partial class AudienceSample
    {
        ...
        {
            // Capture before any AppendLog could land off-main (SDK OnError
            // fires from background flush threads).
        ...
        private void BindElements()
        {
            ...
            _identityUserId       = Require<Label>("identity-userId");
            _identityIdentityType = Require<Label>("identity-identityType");
        ...
        private void RegisterHandlers()
        {
            ...
            _btnFlush.clicked += OnFlush;
            _btnReset.clicked += OnReset;
            _btnShutdown.clicked += OnShutdown;
            _btnDeleteData.clicked += OnDeleteData;
