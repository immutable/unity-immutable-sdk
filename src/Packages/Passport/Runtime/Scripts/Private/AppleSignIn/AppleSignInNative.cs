    ...
    public class AppleSignInNative
    {
        ...
        public static void Initialize()
        {
            ...
            try
            {
                ...
                _isInitialized = true;
                PassportLogger.Info($"{TAG} SUCCESS: Native plugin initialized successfully");
            }
            catch (Exception ex)
            {
                PassportLogger.Error($"{TAG} ERROR: Failed to initialize: {ex.Message}");
                throw;
            }
        }
        ...
        {
            PassportLogger.Info($"{TAG} SUCCESS: Native callback - Success!");
        ...
        {
            PassportLogger.Error($"{TAG} ERROR: Native callback - Error: {errorCode} - {errorMessage}");
        ...
        {
            PassportLogger.Info($"{TAG} WARNING: Native callback - Cancelled");
