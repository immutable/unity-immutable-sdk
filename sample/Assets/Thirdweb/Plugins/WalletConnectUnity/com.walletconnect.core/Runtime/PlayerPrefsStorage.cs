...
namespace WalletConnectUnity.Core
{
    ...
    {
        private const string StorageKey = "WalletConnectUnity.Core.PlayerPrefsStorage";
        ...
        public PlayerPrefsStorage(SynchronizationContext mainThreadContext)
        {
            ...
            _jsonSerializerSaveSettings = new JsonSerializerSettings { TypeNameHandling = TypeNameHandling.All };
            _jsonSerializerLoadSettings = new JsonSerializerSettings { TypeNameHandling = TypeNameHandling.Auto };
        }
